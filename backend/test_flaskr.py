...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgres://{}:{}@{}/{}".format('postgres', 'soso','localhost:5432', self.database_name)
    ...
    #test if problem accour when error accour when delete quesion
    def test_4040_delete_question_exit(self):
    ...
    #test if can search  for question in data base or not 
    ...
    #test if return false if search for question not exit
    def test_serach_not_found(self):
        res = self.client().post('/questions', json={'searchTerm': 'kkkkkkkkkkkkkk'})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data["success"], False)

    #test for questions of spesific category  
    def test_categories_category_id_questions(self):
    ...
    def test_404_categories_category_id_questions(self):
    ...
    def test_quizz_with_error(self):
        quizzes = {'previous_questions': []}
